...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/City.png
  AssetGenImage get city => const AssetGenImage('assets/icons/City.png');

  /// File path: assets/icons/Design.png
  AssetGenImage get design => const AssetGenImage('assets/icons/Design.png');

  /// File path: assets/icons/Rain.png
  AssetGenImage get rain => const AssetGenImage('assets/icons/Rain.png');

  /// File path: assets/icons/Team.png
  AssetGenImage get team => const AssetGenImage('assets/icons/Team.png');

  /// File path: assets/icons/icon.png
  AssetGenImage get icon => const AssetGenImage('assets/icons/icon.png');

  /// List of all assets
  List<AssetGenImage> get values => [city, design, rain, team, icon];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/dew.png
  ...
  /// File path: assets/images/fog_day.png
